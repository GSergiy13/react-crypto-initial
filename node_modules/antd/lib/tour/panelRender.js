...
const TourPanel = props => {
  ...
  const [closable, mergedDisplayCloseIcon] = (0, _useClosable.default)({
    closable: mergedClosable,
    closeIcon: mergedCloseIcon,
    // eslint-disable-next-line react/no-unstable-nested-components
    customCloseIconRender: icon => ( /*#__PURE__*/_react.default.createElement("span", {
      onClick: onClose,
      "aria-label": "Close",
      className: `${prefixCls}-close`
    }, icon)),
    defaultCloseIcon: /*#__PURE__*/_react.default.createElement(_CloseOutlined.default, {
